...
public class InvalidLogin {
    ...
    public void setUserName() throws InterruptedException{
    	...
    	driver.findElement(By.id("floatingInput")).sendKeys("merlinpius@gmail.com");
		Thread.sleep(2000);
		driver.findElement(By.name("password")).sendKeys("merskkj");
		Thread.sleep(2000);
  ...
  //Set password in password textbox
    public void setPassword() throws InterruptedException{
    	driver.findElement(By.id("floatingInput")).sendKeys("merlin@gmai");
		Thread.sleep(2000);
		driver.findElement(By.name("password")).sendKeys("Merlin@1");
		Thread.sleep(2000);
  ...
  //Click on login button
   ...
   public void clickLogin() throws InterruptedException{
	   driver.findElement(By.id("floatingInput")).sendKeys("merlin@gmai");
		...
		driver.findElement(By.name("password")).sendKeys("Merlin@231");
		Thread.sleep(2000);
